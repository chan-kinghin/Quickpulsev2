...
SEED_ENTRIES: List[Dict[str, Any]] = [
    ...
    # ===================================================================
    {
        ...
        "编号格式为[业务线字母][订单类型字母]+年份后两位+序号，例如AK2604007、DS262027S。所有相关单据通过MTO号关联。",
        "tags": "mto,计划跟踪号,追踪,核心概念,业务线,订单类型",
    },
    {
        "concept_id": "bom",
        "category": "concept",
    ...
    },
    {
        ...
        "category": "rule",
        "title": "MTO编号格式规则",
        "content": "MTO编号格式：[业务线字母][订单类型字母] + 年份后两位 + 序号。前两位字母是结构化前缀，不是固定的AK。"
        "第1字母=业务线（A=外销，D=内销，W=瑞弧），第2字母=订单类型（S=完整订单，K=备货半成品单，Y=样品单）。"
        "示例：AS2604007=外销完整订单，AK2604007=外销备货半成品单，DS262027S=内销完整订单（结尾S属于序号，非订单类型），AY开头为外销样品单。"
        "子单在主单号后追加-1/-2等后缀（如AS2604001-1）。查询时MTO号区分大小写，必须完全匹配。",
        "tags": "MTO,格式,编号规则,大小写,业务线,订单类型,前缀",
    },
    {
