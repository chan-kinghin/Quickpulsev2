# 采购订单 (Purchase Order) API Documentation

## Overview
- **Form ID**: `PUR_PurchaseOrder`
- **Module**: 供应链 > 采购管理 > 采购订单
...
### Description
本接口用于实现采购订单 (PUR_PurchaseOrder) 的单据查询(ExecuteBillQuery)功能

### Request Parameters

| Parameter | Type | Required | Default | Description |
|-----------|------|----------|---------|-------------|
| FormId | String | 必录 | PUR_PurchaseOrder | 业务对象表单Id |
...
### Description
本接口用于实现采购订单 (PUR_PurchaseOrder) 的查看(View)功能
